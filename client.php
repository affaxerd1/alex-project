...
<header class="bg-light" id="wrapper" >
    ...
    <div id="rep-wrapper">
        <h2 id="header"> Client reputation</h2>
    ...
    <body>
        ...
        <div class="active-jobs">
            ...
            <div class="active-jobs">
                <div >
                    <h2 id="card-header"> Job status</h2>
                </div>
                <div id="jobs">
                            <?php
                    ...
                    <div class="cards">
                        ...
                        <div>
                            <div id="submit">
                                ...
                                <button id="status" class="submit">status</button>
                            ...
                            <div id="big">
                                ...
                                <div class="divs">
                                    ...
                                    <label><h3> Job Title: <?php echo $q['title'];?></h3></label>
                                    
                                    <br>
                                    <label><h3> Job Duration</h3></label>
                                    <br>
                                    <p?> <?php echo $q['duration']; ?></p> 
                                    <br>
                                    <br>
                                </div>

                                <div class="divs">
                                    <label><h3>Location: <?php echo $q['location']; ?></h3></label>
                                    <br>
                                    <br>
                                    <label><h3>cost: <?php echo $q["cost"];?></h3></label>
                                    <br>
                                    <br>
                                </div>
